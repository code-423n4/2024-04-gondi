...
contract PoolOfferHandlerTest is MultiSourceCommons {
    ...
    function testSetTerms() public {
        ...
        uint256 pendingAprPremium = _poolOfferHandler.getPendingAprPremium(
            address(collateralCollection), _duration, 0, terms[0].principalAmount
        );
        assertEq(pendingAprPremium, terms[0].aprPremium);
